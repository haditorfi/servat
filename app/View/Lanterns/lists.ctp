<?php
 	 $this->assign('title', 'لیست سوالات فانوس دریایی');
 	echo $this->Element('sidebar');
   ?>
<div class="lanterns list">
	...
	<div class="row">
		...
		<div class="col-md-12">
			<table cellpadding="0" cellspacing="0" class="table table-striped table-hover">
				<thead>
					<tr>
						<th nowrap><?php echo $this->Paginator->sort('کد'); ?></th>
						<th nowrap><?php echo $this->Paginator->sort('user_id'); ?></th>
						<th nowrap><?php echo $this->Paginator->sort('سوال'); ?></th>
						<th nowrap><?php echo $this->Paginator->sort('پاسخ'); ?></th>
					</tr>
				</thead>
				<tbody>
