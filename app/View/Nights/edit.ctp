<?php
 	 $this->assign('title', 'ویرایش سوالات شب');
   ?>
...
<h4 style="text-align: center;color: red"><?php echo __('ویرایش سوالات شب'); ?></h4>
	<div class="row">
		...
		<div class="form-group">
			...
			<?php echo $this->Html->link(__('انصراف'),array('controller'=>'mornings','action'=>'lantern'), array('class' => 'btn btn-danger pull-left', 'style'=>'margin:15px')); ?>
		</div>	
	</div><!-- end row -->
</div>
