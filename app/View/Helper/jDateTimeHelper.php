...
App::uses('Helper', 'Controller');

//use Cake\Controller\Component;

class jDateTimeHelper extends Helper
{
     ...
     * j\DateTime::gDate
     *
     * Same as j\DateTime::Date method
