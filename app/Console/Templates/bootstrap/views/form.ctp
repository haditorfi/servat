...
<div class="<?php echo $pluralVar; ?> form">
	...
	<div class="row">
		<div class="col-md-3">
			<div class="well">
				<?php
					echo "\t\t\t\t\t<?php echo \$this->Form->submit(__('Submit'), array('class' => 'btn btn-block btn-default')); ?>\n";
				?>
				<br/>
				<?php
					echo "\t\t\t\t\t<?php echo \$this->Html->link(__('Cancle'),array('action'=>'index'), array('class' => 'btn btn-block btn-danger')); ?>\n";
				?>			
			</div>			
		</div><!-- end col md 3 -->
		<div class="col-md-9">
